...
import { ProductImageUncheckedUpdateManyWithoutProductNestedInput } from '../product-image/product-image-unchecked-update-many-without-product-nested.input';

@InputType()
export class ProductUncheckedUpdateWithoutBranchInput {
    ...
    @Field(() => ProductImageUncheckedUpdateManyWithoutProductNestedInput, {nullable:true})
