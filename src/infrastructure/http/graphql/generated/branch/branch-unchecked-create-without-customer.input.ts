...
import { EmployeeUncheckedCreateNestedManyWithoutBranchInput } from '../employee/employee-unchecked-create-nested-many-without-branch.input';
...
@InputType()
export class BranchUncheckedCreateWithoutCustomerInput {
    ...
    @Field(() => EmployeeUncheckedCreateNestedManyWithoutBranchInput, {nullable:true})
