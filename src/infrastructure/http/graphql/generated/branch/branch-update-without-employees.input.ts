...
import { CustomerUpdateOneRequiredWithoutBranchesNestedInput } from '../customer/customer-update-one-required-without-branches-nested.input';
...
@InputType()
export class BranchUpdateWithoutEmployeesInput {
    ...
    @Field(() => CustomerUpdateOneRequiredWithoutBranchesNestedInput, {nullable:true})
    Customer?: CustomerUpdateOneRequiredWithoutBranchesNestedInput;
