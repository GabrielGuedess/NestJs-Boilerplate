...
import { EmployeeCreateNestedManyWithoutBranchInput } from '../employee/employee-create-nested-many-without-branch.input';
...
@InputType()
export class BranchCreateWithoutCategoryInput {
    ...
    @Field(() => EmployeeCreateNestedManyWithoutBranchInput, {nullable:true})
