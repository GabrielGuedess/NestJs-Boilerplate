...
import { TabCreateNestedOneWithoutOrdersInput } from '../tab/tab-create-nested-one-without-orders.input';
...
export class OrderCreateInput {
    ...
    @Field(() => TabCreateNestedOneWithoutOrdersInput, {nullable:false})
