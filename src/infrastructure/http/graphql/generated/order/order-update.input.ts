...
import { TabUpdateOneRequiredWithoutOrdersNestedInput } from '../tab/tab-update-one-required-without-orders-nested.input';
...
export class OrderUpdateInput {
    ...
    @Field(() => TabUpdateOneRequiredWithoutOrdersNestedInput, {nullable:true})
