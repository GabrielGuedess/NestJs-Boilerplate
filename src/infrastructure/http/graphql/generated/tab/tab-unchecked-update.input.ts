...
import { OrderUncheckedUpdateManyWithoutTabNestedInput } from '../order/order-unchecked-update-many-without-tab-nested.input';

@InputType()
export class TabUncheckedUpdateInput {
    ...
    @Field(() => StringFieldUpdateOperationsInput, {nullable:true})
    table_id?: StringFieldUpdateOperationsInput;

    @Field(() => OrderUncheckedUpdateManyWithoutTabNestedInput, {nullable:true})
